...
router.register('reserve-check', views.ReserveCheckViewSet)
router.register('suspention-check', views.SuspentionCheckViewSet)
router.register('approval-applications', views.ApprovalApplicationViewSet)
router.register('approval-count-monthly', views.ApprovalCountMonthlyViewSet)
