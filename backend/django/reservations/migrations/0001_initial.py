# Generated by Django 3.1.7 on 2021-07-12 15:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('equipment', models.ManyToManyField(blank=True, null=True, related_name='reservation_equipment', to='reservations.Equipment', verbose_name='equipment')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, null=True, related_name='resercvation_special_equipment', to='reservations.SpecialEquipment', verbose_name='special_equipment'),
        ),
        migrations.AddField(
            model_name='reservation',
            name='user',
