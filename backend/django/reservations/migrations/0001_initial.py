# Generated by Django 3.1.7 on 2021-07-13 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.IntegerField(blank=True, null=True, verbose_name='シート数')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('equipment', models.ManyToManyField(related_name='reservation_equipment', to='reservations.Equipment', verbose_name='equipment')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='resercvation_special_equipment', to='reservations.SpecialEquipment', verbose_name='special_equipment'),
        ),
        migrations.AddField(
            model_name='reservation',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('age', models.ManyToManyField(related_name='age_categorize_age', to='reservations.Usage', verbose_name='age')),
