    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_info_user', to='users.user', verbose_name='user')),
            ],
        ),
        migrations.CreateModel(
            name='UsageCategory',
        ...
        migrations.AddField(
            model_name='reservation',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reservation_user', to='users.user', verbose_name='user'),
        ),
        migrations.CreateModel(
            name='FacilityFee',
            fields=[
