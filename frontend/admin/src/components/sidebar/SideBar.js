...
const SideBar = (props) => {
    ...
    return (
        <div className="sideBox">
            ...
            <TransitionBox url="/weeklycalendar" icon={<FontAwesomeIcon icon={faCalendarAlt} />} pagename={"ウィークリーカレンダー"}/>
            <TransitionBox url="/dailycalendar" icon={<FontAwesomeIcon icon={faCalendarAlt} />} pagename={"デイリーカレンダー"}/>
            <TransitionBox url="/monthlycalendar" icon={<FontAwesomeIcon icon={faCalendarAlt} />} pagename={"マンスリーカレンダー"}/>
        </div>
    )
}
