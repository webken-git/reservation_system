...
const ApprovalButton = (props) => {
  ...
  return (
    <>
      <button type="button" className="approval-btn" onClick={() => setModalIsOpen(true)}>承認</button>
        ...
        <div className="buttom-modal-wrapper">
          <form onSubmit={handleSubmit(ApporovalSend)}>
            ...
            <div className="modal-form-group">
              {errors.usage_fee && <p className="modal-error">※この項目は必須です</p>}
              <label className="modal-label">利用料金：</label>
              <input type="number" name="usage_fee" className="modal-input"
                {...register("usage_fee", { required: true })}
              />
            </div>
            <div className="modal-form-group">
              {errors.electric_fee && <p className="modal-error">※この項目は必須です</p>}
              <label className="modal-label">電気料金：</label>
              <input type="number" name="electric_fee" className="modal-input"
                {...register("electric_fee", { required: true })}
              />
            </div>
            <div className="modal-form-group">
              {errors.heating_fee && <p className="modal-error">※この項目は必須です</p>}
              <label className="modal-label">暖房料金：</label>
              <input type="number" name="heating_fee" className="modal-input"
                {...register("heating_fee", { required: true })}
              />
            </div>
            <div className="modal-form-group">
              <button type="submit" className="btn">承認</button>
              <span>　</span>
