...
const EditCurlingFeeList = (props) => {
  ...
  const anHour = timeList.filter((timeList) => timeList.timeName === "１シート１時間につき");
  const timeList2 = timeList.filter((timeList) => timeList.timeName !== "１シート１時間につき");
